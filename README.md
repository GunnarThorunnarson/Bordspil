...
:warning: **Ekki nota pinna; GPIO0, GPIO3, GPIO19, GPIO20, GPIO45, GPIO46.** :warning:
   ...
   <!-- [nótur og tíðni](https://muted.io/note-frequencies/) -->
<!--
...
1. Náðu í [boxið](https://github.com/GunnarThorunnarson/Bordspil/blob/main/Kassi.svg) og opnaðu það svo í [Inkscape](https://github.com/GunnarThorunnarson/Bordspil/blob/main/Inkscape.md) forritinu.
1. Notaðu Inkscape til að skreytaa boxið. Notaðu rauðan lit fyrir texta og myndir.
